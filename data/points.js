const pointsDePassage = [
            ...
            { name: "Bifurcation de Créteil", PK: 9.326, duree: 350, lat: 48.77490, lon: 2.43626, retard: 0 },
            ...
            { name: "Bifurcation de Chevry-Cossigny", PK: 21.486, duree: 300, lat: 48.70186, lon: 2.68159, retard: 0 },
            { name: "Bifurcation V.1 de Solers", PK: 26.500, duree: 86, lat: 48.67599, lon: 2.72792, retard: 0 },
            { name: "Bifurcation de Moisenay", PK: 17.099, duree: 220, lat: 48.56911, lon: 2.75358, retard: 0 },
            { name: "Viaduc de Montereau", PK: 42.740, duree: 343, lat: 48.39683, lon: 2.97820, retard: 0 },
            { name: "SEI de Marolles", PK: 49.230, duree: 83, lat: 48.37260, lon: 3.05381, retard: 0 },
            { name: "Passage sous l'A19", PK: 72.200, duree: 299, lat: 48.25960, lon: 3.28652, retard: 0 },
            { name: "SEI de Vaumort", PK: 92.778, duree: 290, lat: 48.11586, lon: 3.44976, retard: 0 },
            { name: "Viaduc sur le canal de Bourgogne", PK: 115.752, duree: 294, lat: 47.98193, lon: 3.67834, retard: 0 },
            { name: "Bifurcation  de Vergigny vers le racc. sud", PK: 117.959, duree: 26, lat: 47.97407, lon: 3.69335, retard: 0 },
            { name: "SEI Tonnerre", PK: 139.817, duree: 290, lat: 47.85008, lon: 3.92233, retard: 0 },
            { name: "Bifurcation V.1 de Pasilly", PK: 161.746, duree: 294, lat: 47.68374, lon: 4.07910, retard: 0 },
            { name: "Viaduc d'Époisses", PK: 185.353, duree: 330, lat: 47.48607, lon: 4.15635, retard: 0 },
            { name: "SEI de Lacour d'Arcenay", PK: 202.367, duree: 255, lat: 47.34790, lon: 4.24603, retard: 0 },
            { name: "Viaduc de Saulieu", PK: 208.686, duree: 95, lat: 47.29473, lon: 4.27178, retard: 0 },
            { name: "SEI de Vianges", PK: 225.809, duree: 225, lat: 47.14900, lon: 4.34201, retard: 0 },
            ...
            { name: "SEI de Vaux-en-Pré", PK: 292.995, duree: 279, lat: 46.61190, lon: 4.60418, retard: 0 },
            { name: "SEI de Cluny", PK: 313.579, duree: 270, lat: 46.43449, lon: 4.67387, retard: 0 },
            ...
            { name: "SEI de Cessein", PK: 361.134, duree: 392, lat: 46.06674, lon: 4.84928, retard: 0 },
            ...
            { name: "Bifurcation de Grenay-Nord", PK: 416.647, duree: 95, lat: 45.66017, lon: 5.07287, retard: 0 },
            ...
            { name: "Bifurcation vers le racc. de Bollène", PK: 578.411, duree: 115, lat: 44.30675, lon: 4.70120, retard: 0 },
            { name: "SEI de Piolenc", PK: 595.040, duree: 230, lat: 44.16485, lon: 4.73397, retard: 0 },
            { name: "Bifurcation d'Avignon-Nord", PK: 617.742, duree: 330, lat: 43.97382, lon: 4.73681, retard: 0 },
            ...
            { name: "Bifurcation des Tuileries", PK: 711.001, duree: 300, lat: 43.35441, lon: 5.35259, retard: 0 },
