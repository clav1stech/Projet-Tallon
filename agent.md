...
- `js/master-routes-data.js` : chargement, validation et export du schéma v3 partagés par les éditeurs.
  `js/train-points-model.js` + `js/train-points-editor.js` + `train-points-editor.html` : placement cartographique rail sur OpenRailwayMap, avec positions directionnelles V1/V2 pour les bifurcations et export manuel validé.
